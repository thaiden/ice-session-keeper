//package com.cisco.wx2.ice.attribute;
//
//import com.cisco.wx2.stun.exception.StunException;
//import com.cisco.wx2.stun.util.UtilityException;
//
//public abstract class IceControl
//    extends Attribute
//{
//    /**
...
//     * create
//     */
//    IceControl(boolean isControlling)
//    {
//        super(isControlling ? ICE_CONTROLLING : ICE_CONTROLLED,
//              isControlling ? MessageAttributeType.ICE_CONTROLLING : MessageAttributeType.ICE_CONTROLLED);
...
//            return true;
//
//        IceControl iceControlAtt = (IceControl)obj;
...
//
//    @Override
//    public byte[] getBytes() throws UtilityException, UtilityException {
//        return encode();
//    }
//}
